...
(cd "/c/Program Files (x86)/Steam/steamapps/common/Black Reliquary/localization/";ls -l *.loc2 | cut -d " " -f 10;rm *.loc2) 2> /dev/null
rm review/*.xml
rm build/*.xml
...
(cd "/c/Program Files (x86)/Steam/steamapps/common/Black Reliquary/localization/"; ls -l *.loc2 | cut -d " " -f 10)
